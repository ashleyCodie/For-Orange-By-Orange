...
const Home = () => {
  return (
    <>
      <div className="h-auto text-base sm:text-md md:text-lg lg:text-2xl">
        ...
        <div className="grid grid-cols-3 mt-20 pt-20 absolute top-10 z-10 text-center text-5xl text-orange-500">
          {/* //section 1 */}
          <div className="text-blue-700 text-base sm:text-md md:text-lg lg:text-2xl">
          ...
          <span className="text-4xl pt-20 ml-15 me-40 pl-90 pe-96 absolute top-0 left-50 z-10 text-blue-700 text-base sm:text-md md:text-lg lg:text-2xl">
          ...
          <span className="text-4xl pt-23 ml-96 me-5 pl-96 absolute top-0 left-50 z-10 text-blue-700 text-base sm:text-md md:text-lg lg:text-2xl" style={{marginLeft: "800px"}}>
      ...
      <p className="relative mt-10 z-10 p-8 text-center text-2xl text-orange-500">
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">For Orange. By Orange.</span> is
        ...
        Features of{" "}
        <span className="text-blue-700 pt-10 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">
          For Orange. By Orange.
        </span>
        <br />
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">~ A Resource Library ~ </span>
        ...
        <br />
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">
          ~ A Support Network ~
        </span>{" "}
        ...
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">~ Job Board ~ </span> Our job
        ...
        <br />
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">~ Community Events ~ </span>
        ...
        <span className="text-blue-700 text-3xl text-base sm:text-md md:text-lg lg:text-2xl">~ Housing Assistance ~</span>
